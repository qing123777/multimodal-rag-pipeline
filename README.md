...
| **1)** `What does the CPSA+ dashboard look like after logging in?` <br><br> **2)**`What information is shown on the Allocated Certification Number screen?` | Image retrieval + visual reasoning |
